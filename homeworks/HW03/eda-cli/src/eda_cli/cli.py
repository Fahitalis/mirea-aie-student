...
def report(
    ...
    top_k_categories: int = typer.Option(5, help="Количество выводимых значений категориальных признаков")
) -> None:
    """
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Колонки, где все значения одинаковые: **{quality_flags['has_constant_columns']}**\n")
        f.write(f"- Идентификаторы не уникальны: **{quality_flags['has_suspicious_id_duplicates']}**\n\n")
        ...
        f.write(f"Количество выводимых значений - {top_k_categories}\n\n")
        if not top_cats:
